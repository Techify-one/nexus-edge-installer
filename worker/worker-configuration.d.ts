/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: a6f3f6b3a0849f68c7ee9cbaea72b88e)
// Runtime types generated with workerd@1.20260820.1 2026-08-26 nodejs_compat
interface __BaseEnv_Env {
	RELEASES: R2Bucket;
	ASSETS: Fetcher;
	ENVIRONMENT: "staging";
	INSTALLER_ORIGIN: "https://installer.francisconeto.net.br";
	OAUTH_CLIENT_ID: "742459137762a85c561a53db69d1d515";
	OAUTH_REDIRECT_URI: "https://installer.francisconeto.net.br/oauth/callback";
	OAUTH_SCOPES: "account-settings.read d1.write queues.write workers-scripts.write workers-routes.write zone.read";
	RELEASE_CHANNEL: "stable";
	RELEASE_PUBLIC_KEY: "MCowBQYDK2VwAyEA1OKQdSIG/k/H12TF+3Z66x9192pbTbbpTRWlJBOwXl8=";
	RELEASE_PUBLIC_KEY_NEXT: "MCowBQYDK2VwAyEAV4gfQre2L/V47J5LeCeUbFY6GYkW3PHJNABtsoHuvIU=";
	INSTALLER_VERSION: "1.0.0";
	SESSION_TTL_SECONDS: "3600";
	METADATA_TTL_SECONDS: "86400";
	OAUTH_CLIENT_SECRET: string;
	SESSION_ENCRYPTION_KEY: string;
	INSTALLATION_SESSION: DurableObjectNamespace<import("./src/index").InstallationSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "InstallationSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "INSTALLER_ORIGIN" | "OAUTH_CLIENT_ID" | "OAUTH_REDIRECT_URI" | "OAUTH_SCOPES" | "RELEASE_CHANNEL" | "RELEASE_PUBLIC_KEY" | "RELEASE_PUBLIC_KEY_NEXT" | "INSTALLER_VERSION" | "SESSION_TTL_SECONDS" | "METADATA_TTL_SECONDS" | "OAUTH_CLIENT_SECRET" | "SESSION_ENCRYPTION_KEY">> {}
}
